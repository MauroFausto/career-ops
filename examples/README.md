...
| `ats-normalization-test.md` | Regression fixture for `src/generators/generate-pdf.mjs` Unicode normalization -- lists every problematic codepoint and its ASCII-safe replacement |
